...
export default {
    ...
    methods:{
        ...
        drawKline(){
            ...
            var upColor = '#FD8787';
            var upBorderColor = '#FD8787';
            var downColor = '#6CC47C';
            var downBorderColor = '#6CC47C';
                ...
                tooltip: {
                    ...
                    formatter: function (params) {
                        return  '时间 ' + params[0].name + '<br/>' +
                                '开 ' + params[0].value[1] + '<br/>' +
                                '高 ' + params[0].value[4] + '<br/>' +
                                '收 ' + params[0].value[2] + '<br/>' +
                                '低 ' + params[0].value[3] + '<br/>' +
                                '涨跌额 ' + "<span style='color:#FD8787;'>" + "+82.87" + '</span><br/>' +
                                '涨跌幅 ' + "<span style='color:#FD8787;'>" + "+3.06%" + '</span><br/>'
                    },
                },
                xAxis: {
                    type: 'category',
