<template>
  <div class="content">
    ...
    <div class="nav">
      <div class="nav-left">
        <li>开盘 <span>3975.86</span></li>
        <li>最高 <span style="color: #FD8787">3975.86</span></li>
        <li>收盘 <span>3975.86</span></li>
        <li>最低 <span style="color: #6CC47C">3975.86</span></li>
      </div>
      <div class="nav-right">
        <p>+2.05%</p>
    ...
    <div class="usdt">
      <div class="u-left">可用 <span>54356.00 USDT</span></div>
      <div class="u-right">占用 <span>3423.00 USDT</span></div>
    </div>

    <div class="sale">
      <div class="sale-in">3993.<span style="font-size: 20px">18</span> 卖出</div>
      <div class="circle">10</div>
      <div class="sale-out">3993.<span style="font-size: 20px">28</span> 买入</div>
    </div>
  </div>
</template>
